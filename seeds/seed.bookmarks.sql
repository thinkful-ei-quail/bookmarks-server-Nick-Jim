...
VALUES
  ...
  ('Reddit', 'http://www.reddit.com', 'Some say the front page of the internet.', 4),
  ('Instagram', 'http://www.instagram.com', 'Better on my phone.', 3),
  ('MDN Web Docs', 'http://www.developer.mozilla.org/en-US', 'A great tool for developers.', 4),
  ('W3 Schools', 'http://www.w3schools.com', 'Another great tool for developers.', 4);